...
const BalanceItem = ({ net, bal, address, dark }) => (
  <motion.a
    ...
    className={cn(
      ...
      dark ? "bg-gray-700 hover:bg-[rgb(38,181,98)]" : "bg-white hover:bg-[rgb(38,181,98)]"
    )}
  >
    <div className="flex items-center gap-2">
      <img src={icons[net]} alt={net} className="w-6 h-6" />
      <span>{net}</span>
    </div>
    <div>{bal} {net.includes("BRN") ? "BRN" : "ETH"}</div>
  </motion.a>
);
